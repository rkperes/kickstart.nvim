...
vim.keymap.set('n', ']q', vim.diagnostic.goto_next, { desc = 'Goto next diagnostic' })
vim.keymap.set('n', '[q', vim.diagnostic.goto_prev, { desc = 'Goto previous diagnostic' })
...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>c', group = '[C]ode (LSP)', mode = { 'n', 'v' } },
      },
    },
  },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = '[S]earch by [G]rep (include tests, hidden and gitignored)' })
      ...
      end, { desc = '[S]earch by [G]rep in oil directory' })
